    ...
    public class DruggistService
    {
        ...
        public void Create(Admin admin)
        {
            ...
            else
            {
                ...
                ExperienceInput: ConsoleHelper.WriteWithColor("Enter your experience in years (Note:If your age 18 or younger 18 you can not have experience): ", ConsoleColor.Blue);
                byte experience;
        ...
        public void Update(Admin admin)
        {
            ...
            else
            {
                ...
                ExperienceInput: ConsoleHelper.WriteWithColor("New experience (Note that experience in age of younger than 18 does not count): ", ConsoleColor.Blue);
                byte experience;
                isSucceeded = byte.TryParse(Console.ReadLine(), out experience);
                if (!isSucceeded)
                {
