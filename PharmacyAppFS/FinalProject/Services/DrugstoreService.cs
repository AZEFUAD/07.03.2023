...
namespace FinalProject.Services
{
    public class DrugstoreService
    {
        ...
        public void GetAllDrugstoresByOwner()
        {
            ...
            {
                ConsoleHelper.WriteWithColor("A drugstore must be created in advance", ConsoleColor.Yellow);
            }
            else
            {
        ...
        public void Create(Admin admin)
        {
            ...
            {
                ConsoleHelper.WriteWithColor("An owner must be created in advance", ConsoleColor.Yellow);
            }
            else
            {
                ...
                DrugstoreEmailInput: ConsoleHelper.WriteWithColor("Enter drugstore's email or gmail: ", ConsoleColor.Blue);
                ...
                if (dbOwner is null)
                {
                    ConsoleHelper.WriteWithColor("Unfortunately no owner with this id!", ConsoleColor.Red);
                    goto OwnerIdInput;
                }
        ...
        public void Update(Admin admin)
        {
            if (_drugstoreRepository.GetAll().Count == 0)
            {
                ConsoleHelper.WriteWithColor("No drugstores have", ConsoleColor.Yellow);
            }
            else
            {
                GetAll();
            ...
            DrugstoreIdInput: ConsoleHelper.WriteWithColor("Enter drugstore's id ", ConsoleColor.Blue);
                ...
                {
                    ConsoleHelper.WriteWithColor("Unfortunately no such a drugstore with this Id", ConsoleColor.Red);
                    return;
                }
                InternalUpdate(drugstore, admin);
                ConsoleHelper.WriteWithColor("Drugstore updated!", ConsoleColor.Green);
            }
        }
